...
DNACalibDNAReader.__new__ = __new_decorator(_py3dnacalib.DNACalibDNAReader_create, DNACalibDNAReader.__new__)
DNACalibDNAReader.__del__ = lambda instance: _py3dnacalib.DNACalibDNAReader_destroy(instance)
