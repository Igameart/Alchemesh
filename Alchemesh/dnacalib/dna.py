...
FileStream.__new__ = __new_decorator(_py3dna.FileStream_create, FileStream.__new__)
FileStream.__del__ = lambda instance: _py3dna.FileStream_destroy(instance)
FileStream.__init__ = __managed_init
del FileStream.create
del FileStream.destroy


MemoryMappedFileStream.__new__ = __new_decorator(_py3dna.MemoryMappedFileStream_create, MemoryMappedFileStream.__new__)
MemoryMappedFileStream.__del__ = lambda instance: _py3dna.MemoryMappedFileStream_destroy(instance)
MemoryMappedFileStream.__init__ = __managed_init
del MemoryMappedFileStream.create
del MemoryMappedFileStream.destroy


MemoryStream.__new__ = __new_decorator(_py3dna.MemoryStream_create, MemoryStream.__new__)
MemoryStream.__del__ = lambda instance: _py3dna.MemoryStream_destroy(instance)
...
BinaryStreamReader.__new__ = __new_decorator(_py3dna.BinaryStreamReader_create, BinaryStreamReader.__new__)
BinaryStreamReader.__del__ = lambda instance: _py3dna.BinaryStreamReader_destroy(instance)
BinaryStreamReader.__init__ = __managed_init
del BinaryStreamReader.create
del BinaryStreamReader.destroy


JSONStreamReader.__new__ = __new_decorator(_py3dna.JSONStreamReader_create, JSONStreamReader.__new__)
JSONStreamReader.__del__ = lambda instance: _py3dna.JSONStreamReader_destroy(instance)
...
BinaryStreamWriter.__new__ = __new_decorator(_py3dna.BinaryStreamWriter_create, BinaryStreamWriter.__new__)
BinaryStreamWriter.__del__ = lambda instance: _py3dna.BinaryStreamWriter_destroy(instance)
BinaryStreamWriter.__init__ = __managed_init
del BinaryStreamWriter.create
del BinaryStreamWriter.destroy


JSONStreamWriter.__new__ = __new_decorator(_py3dna.JSONStreamWriter_create, JSONStreamWriter.__new__)
JSONStreamWriter.__del__ = lambda instance: _py3dna.JSONStreamWriter_destroy(instance)
